                        ...
                        <div id="infoSta">
                            <div id="accountstatus2">
                            	  <dl id="authValiCode">
									...
									<dd>
										<input class="inp" name="ys_name" id="nikename" type="text">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
                                    <dt id="mobile_dt">联系方式</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_number" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">单位电话</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_guhua" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									<dt id="mobile_dt">照片上传</dt>
                                    <dd id="mobile_dd">
                    <input type="file" name='ys_img' class='inp'/>
                  </li>
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									<dt id="mobile_dt">所属医院</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_yiyuan" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>

                                    <dt id="mobile_dt">身份证号</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_idcard" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">民族</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_minzu" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">年服务费</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yy_fuwufei" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                            ...
                            <div id="vCodeInfo"></div>
									...
									<dd>
										...
										<input name="ys_xingbie" id="gender" value="1" type="hidden">
										...
										<div class="prompt" id="sexPmt"><span>*</span>&nbsp;提交后不可更改</div>
																		...
																		<dt>生日</dt>
									<dd style="z-index:6">		                		
										<input name="ys_birthday" id="myBirthday1" value="0" type="hidden">
										...
										<div class="infolayer" style="display:none" id="_se3">
											<p></p>
																											...
																											<dt>地区</dt>
									<dd style="z-index:5">
										<input name="ys_zhuzhi" id="mycityId" value="" type="hidden">
										<div class="bor">
                        ...
                        <dl>
                            ...
                            <dd class="w02" style="z-index:3">
                                <input name="" value="内科" readonly="readonly" class="inp02" id="mymarriage" type="text">
                                <input name="ys_keshi" id="csmarriage" value="内科" type="hidden">
                            ...
                            <dt id="mobile_dt">职称</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="ys_zhiwei" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                        ...
                        <div style="display:none;"><textarea name="goldUserDesc_userDesc" id="userdesc" cols="30" rows="10"></textarea></div>
						    <div style="display:none;"><textarea name="goldUserDes

c_userDesc" id="userdesc" cols="30" rows="10"></textarea></div>
                        <div class="terms"><input name="promit" type="checkbox" checked="checked" id="promit" />已经阅读并同意<a href="" target="_blank">中国保健大夫服务条款</a></div>
