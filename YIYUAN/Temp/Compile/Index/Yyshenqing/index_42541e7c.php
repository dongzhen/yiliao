...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        #neirong{
            ...
            <h1 id="toubu"><strong>请完善保健医院申请资料</strong></h1>
                <div class="angle"></div>
            </div>
                    ...
                    <div class="apply">
                        <div id="infoSta">
                            <div id="accountstatus2">
                            	  <dl id="authValiCode">
                            	                                      <dt id="mobile_dt">医院名</dt>
									<dd>
										<input class="inp" name="yy_name" id="nikename" type="text">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
                                    <dt id="mobile_dt">联系电话</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yy_number" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">医院等级</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yy_dengji" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                  
									<dt id="mobile_dt">申请人</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yy_shenqingren" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
						<dt id="mobile_dt">医院图标</dt>
                                    <dd id="mobile_dd">
                    <input type="file" name='yy_img' class='inp'/>
                  </li>
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>

                                    <dt id="mobile_dt">医院类型</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yy_leixing" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                            ...
                                            <p></p>
                                                                                                            ...
                                                                                                            <dt>地区</dt>
                                    <dd style="z-index:5">
                                        <input name="yy_dizhi" id="mycityId" value="" type="hidden">
                                        <div class="bor">
