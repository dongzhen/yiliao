...
URL = 'http://localhost/baojiandaifu/index.php/Admin/Yiyuan/index';
...
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/Yiyuan/index';
...
HISTORY = 'http://localhost/baojiandaifu/index.php/Admin/Yiyuan/edit/nid/3';
</script>
    <style type="text/css">
        #duihao{
            color: green;
...
<div class='menu_list'>
    <ul>
        <li>
            <a href="<?php echo U('add');?>">添加保健医院</a>
        </li>
        <li>
            <a href="<?php echo U('chakan');?>">查看保健医院</a>  
        </li>
    </ul>
</div>
<div class='menu_list'>
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
        ...
        <tr>
            ...
            <td><?php echo $d['yiyuandizhi'];?></td>
            <td><?php echo $d['yiyuannumber'];?></td>
            <td><?php echo $d['username'];?></td>
            <td><?php echo $d['password'];?></td>
            <td>
                <a href="<?php echo U('edit',array('nid'=>$d['nid']));?>">修改</a> |
                <a href="<?php echo U('del',array('nid'=>$d['nid']));?>" onclick="return confirm('你确定要与该保健医生解除合作关系么?');">解除合作</a> |
                <a href="">查看其管理用户</a>
            </td>
        </tr>
