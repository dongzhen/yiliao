...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    	<script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/tongji-1.js" type="text/javascript" charset="utf-8"></script>
        ...
        <title>保健医生查询</title>
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/public.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/topics.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/pop.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/20140925.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/formStyle.css" rel="stylesheet" type="text/css">
        <style>
    ...
    /*头部开始*/
        ...
        #neirong{
            ...
            </script></head><body><div id="baidu_stat_id" style="display:none;"><script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/h.js" type="text/javascript"></script></div>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/jquery-1.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/baihe.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/city.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/jquery.js" charset="utf-8"></script>    
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/reg_landpage.js" charset="utf-8"></script>
            <script language="javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghuyiyuan/data/ckadinfo.js" charset="utf-8"></script>
 ...
 <!-- 头部开始 -->
    ...
    <!-- 导航块开始 -->
        <div id="daohang">
            ...
            <h1 id="toubu"><strong>查找您想要申请的保健医院</strong></h1>
                <div class="angle"></div>
            </div>
