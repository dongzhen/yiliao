...
URL = 'http://localhost/baojiandaifu/index.php/Admin/Yysq/index';
...
CONTROLLER = 'http://localhost/baojiandaifu/index.php/Admin/Yysq';
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/Yysq/index';
...
CONTROLLERVIEW = 'http://localhost/baojiandaifu/YIYUAN/Admin/View/Yysq';
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
        ...
        <tr>
            <td style="display:none;"><?php echo $d['yy_id'];?></td>
            <!-- <td><?php echo $d['yishengname'];?></td> -->
            <td><?php echo $d['yy_name'];?></td>
            <td><?php echo $d['yy_number'];?></td>
            <!-- <td><?php echo $d['password'];?></td> -->
            <td>
            <a href="<?php echo U('xinxi',array('yy_id'=>$d['yy_id']));?>">查看申请人详细信息</a> |
                <a href="<?php echo U('tongguo',array('yy_id'=>$d['yy_id']));?>"onclick="return confirm('你确定要通过本申请么?');">同意申请</a> |
                <a href="<?php echo U('del',array('yy_id'=>$d['yy_id']));?>" onclick="return confirm('标记已读后申请信息将被删除，您确定要这么做么？');">删除申请</a> |
...
<script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Admin/View/Yysq/js/js.js"></script>
<div class='page1'>
   <?php echo $page;?>
</div>
</body>
