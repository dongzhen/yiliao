...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        #neirong{
            ...
            <h1 id="toubu"><strong>修改保健医院信息</strong></h1>
                <div class="angle"></div>
            </div>
                    ...
                    <div class="apply">
                        <div id="infoSta">
                            <div id="accountstatus2">
                            	  <dl id="authValiCode">
                            	                                      <dt id="mobile_dt">医院名称</dt>
									<dd>
										<input class="inp" name="yiyuanname" id="nikename" type="text" value="<?php echo $y['yiyuanname'];?>">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
									<dt id="mobile_dt">等级</dt>
									<dd>
										<input class="inp" name="yiyuandengji" id="nikename" type="text" value="<?php echo $y['yiyuandengji'];?>">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
<!--                                     <dt id="mobile_dt">服务热线</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yiyuannumber" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd> -->
                                    <dt id="mobile_dt">服务热线</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yiyuannumber" id="mobile_new" type="text" value="<?php echo $y['yiyuannumber'];?>">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									<dt id="mobile_dt">医院logo</dt>
                                    <dd id="mobile_dd">
                    <input type="file" name='yy_img' value="<?php echo $y['yy_img'];?>" class='inp'/>
                  </li>
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									
                                    <dt id="mobile_dt">账号：</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="username" value="<?php echo $y['username'];?>" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">密码：</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="password" value="<?php echo $y['password'];?>" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>


                            <dt id="mobile_dt">类型</dt>
                                    <dd id="mobile_dd">
                                        <input value="<?php echo $y['yiyuanleixing'];?>" class="inp" name="yiyuanleixing" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
