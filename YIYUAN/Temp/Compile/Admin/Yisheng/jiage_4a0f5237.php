...
URL = 'http://localhost/yiyuan/index.php/Admin/Yisheng/jiage';
...
CONTROLLER = 'http://localhost/yiyuan/index.php/Admin/Yisheng';
ACTION = 'http://localhost/yiyuan/index.php/Admin/Yisheng/jiage';
...
CONTROLLERVIEW = 'http://localhost/yiyuan/YIYUAN/Admin/View/Yisheng';
</script>
	<style type="text/css">
		#duihao{
			color: green;
...
<div class='menu_list'>
    <ul>
        <li>
            <a href="<?php echo U('Index/yindex');?>">返回用户列表</a>
        </li>
    </ul>
</div>
<div class='menu_list'>
...
<script type="text/javascript" src="http://localhost/yiyuan/YIYUAN/Admin/View/Yisheng/js/js.js"></script>
<div class='page1'>
   <?php echo $page;?>
</div>
</body>
