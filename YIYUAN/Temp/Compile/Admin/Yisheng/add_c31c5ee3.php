...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        #neirong{
            ...
            <h1 id="toubu"><strong>添加保健医生</strong></h1>
                <div class="angle"></div>
            </div>
                        ...
                        <div id="infoSta">
                            <div id="accountstatus2">
                            	  <dl id="authValiCode">
									...
									<dd>
										<input class="inp" name="yishengname" id="nikename" type="text">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
                                    <dt id="mobile_dt">联系方式</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yishengnumber" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">单位电话</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="guhua" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									<dt id="mobile_dt">照片上传</dt>
                                    <dd id="mobile_dd">
                    <input type="file" name='img' class='inp'/>
                  </li>
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
									<dt id="mobile_dt">所属医院</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yiyuanname" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">管理账号</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="username" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
