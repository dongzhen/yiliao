...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    	<script src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/tongji-1.js" type="text/javascript" charset="utf-8"></script>
        ...
        <link href="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/public.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/topics.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/pop.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/20140925.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/formStyle.css" rel="stylesheet" type="text/css">
        <style>
        #toubu{
        	position: absolute;
        	left: 46%;
        ...
        #neirong{
            ...
            </script></head><body><div id="baidu_stat_id" style="display:none;"><script src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/h.js" type="text/javascript"></script></div>
            <script type="text/javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/jquery-1.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/baihe.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/city.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/jquery.js" charset="utf-8"></script>    
            <script type="text/javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/reg_landpage.js" charset="utf-8"></script>
            <script language="javascript" src="http://localhost/yiyuan1/YIYUAN/Index/View/Login/data/ckadinfo.js" charset="utf-8"></script>
            ...
            <h1 id="toubu"><strong>请完善保健医生申请资料</strong></h1>
                <div class="angle"></div>
            </div>
                    ...
                    <div class="apply">
                        ...
                        <dl>
                            ...
                            <dd class="w01" style="z-index:4">
                                ...
                                <input name="shengao" value="内科" id="csheight" type="hidden">
                                <div class="prompt" id="myheight_msg"><div class="ok">正确</div></div>

                                <div class="infolayer01" style="display:none;" id="_myheight">
                                    <a href="#" value="五官科">五官科</a>
                                    <a href="#" value="内科">内科</a>
                                    <a href="#" value="外科">外科</a>
                                    <a href="#" value="皮肤科">皮肤科</a>
                                    <a href="#" value="妇产科">妇产科</a>
                                    <a href="#" value="149">心理门诊</a>
                                    <a href="#" value="150">放射科</a>
