...
URL = 'http://127.0.0.1/baojiandaifu/index.php/Admin/Shuju/index';
...
CONTROLLER = 'http://127.0.0.1/baojiandaifu/index.php/Admin/Shuju';
ACTION = 'http://127.0.0.1/baojiandaifu/index.php/Admin/Shuju/index';
...
CONTROLLERVIEW = 'http://127.0.0.1/baojiandaifu/YIYUAN/Admin/View/Shuju';
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
        ...
        <tr>
            ...
            <td><?php echo $d['StrCode'];?></td>
            <td><?php echo $d['InsCode'];?></td>
            <td><?php echo $d['Cmd'];?></td>
            <td><?php echo $d['CardCode'];?></td>
            <td><?php echo $d['Data'];?></td>
            <td><?php echo $d['EndFlag'];?></td>
...
<script type="text/javascript" src="http://127.0.0.1/baojiandaifu/YIYUAN/Admin/View/Shuju/js/js.js"></script>
<div class='page1'>
   <?php echo $page;?>
</div>
</body>
