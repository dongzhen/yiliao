...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    	<script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/tongji-1.js" type="text/javascript" charset="utf-8"></script>
        ...
        <title>保健医生查询</title>
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/public.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/topics.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/pop.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/20140925.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/formStyle.css" rel="stylesheet" type="text/css">
        <style>
    ...
    /*头部开始*/
        ...
        #neirong{
            ...
            </script></head><body><div id="baidu_stat_id" style="display:none;"><script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/h.js" type="text/javascript"></script></div>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/jquery-1.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/baihe.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/city.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/jquery.js" charset="utf-8"></script>    
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/reg_landpage.js" charset="utf-8"></script>
            <script language="javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Yonghu/data/ckadinfo.js" charset="utf-8"></script>
    ...
    <!-- 导航块开始 -->
        <div id="daohang">
            <div class="d_center">
                ...
                <div class="fuwu">
                    <ul class="fw">
                        <li><a href="<?php echo U('Index/yonghu');?>">首页</a></li>
                        <li><a href="<?php echo U('Yonghu/shenqing');?>">申请保健医生</a></li>
                        <li><a href="">申请保健医院</a></li>
                        <li><a href="">健康信息反馈</a></li>
                    </ul>
                </div>       
            </div>
        </div>
