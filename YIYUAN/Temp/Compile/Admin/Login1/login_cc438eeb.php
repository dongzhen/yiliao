...
<head>
	...
	<style type="text/css">
		*{ padding: 0; margin: 0; background: #f4f7f9;}
		...
		#boxs .tops{ height: 50px; background: url(http://localhost/yiyuan/YIYUAN/Admin/View/Index/images/login_bg.png) repeat-x; border-radius:5px 5px 0px 0px; text-align: center; line-height: 50px; letter-spacing: 1px; color: #fff;}
		...
		#boxs .sub{ width: 100px; height: 35px; background: url(http://localhost/yiyuan/YIYUAN/Admin/View/Index/images/login_user.png) repeat-x; border-radius: 5px; color: #fff; font-weight: 700; margin-top: 15px; font-size: 14px; letter-spacing: 2px;}
		#quanxian{
			width: 300px;
			height: 400px;
			/*background: yellow;*/
