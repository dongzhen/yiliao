...
URL = 'http://localhost/baojiandaifu/index.php/Admin/Yiyuan/yylogin';
...
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/Yiyuan/yylogin';
...
HISTORY = 'http://localhost/baojiandaifu/index.php/Admin/Login/Login';
</script>
    <style type="text/css">
        #duihao{
            color: green;
