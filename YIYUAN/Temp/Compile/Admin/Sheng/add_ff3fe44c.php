...
URL = 'http://localhost/yiyuan/index.php/Admin/Sheng/add';
...
ACTION = 'http://localhost/yiyuan/index.php/Admin/Sheng/add';
...
echo "";
				...
				<tr>
					<th>公司名称</th>
					<td>
						<input type="text" name='dname' class='w200'>
					</td>
				</tr>				
				<tr>
					<th>负责人姓名</th>
				...
				<tr>
					<th>公司地址</th>
					<td>
						<input type="text" value='' name='ddizhi' class='w200'> 
					</td>
				</tr>
				<tr>
					<th>代理登录权限帐号</th>
					<td>
						<input type="text"  name='dkey' class='w200'> 
					</td>
				</tr>
				<tr>
					<th>代理登陆权限密码</th>
					<td>
						<input type="text" name='dpassword' class="w200">
					</td>
				</tr>
			</table>
