    ...
    <body>
      ...
      <div id="daohang">
        ...
        <div class="zouqi">
                ...
                <a class="li" href="<?php echo U('Index/yyindex');?>">返回用户管理列表</a>&nbsp|&nbsp<a class="li" href="<?php echo U('Index/yindex');?>">信息发送</a>
...
<!--                    <a href="" class="xinxi">姓名：<?php echo $shuju['xingming'];?>&nbsp&nbsp性别：<?php echo $shuju['xingbie'];?>&nbsp&nbsp出生日期：<?php echo $shuju['shengri'];?></a>
            ...
            <img src="http://localhost/baojiandaifu/YIYUAN/Index/View/Index/2.gif" style="height:100px;margin-left:360px; width:70%; margin-top:-100px;" alt="">
