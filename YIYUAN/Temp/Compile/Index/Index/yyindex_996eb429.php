...
URL = 'http://localhost/baojiandaifu/index.php/Index/Index/yyindex';
...
ACTION = 'http://localhost/baojiandaifu/index.php/Index/Index/yyindex';
...
HISTORY = 'http://localhost/baojiandaifu/index.php/Index/Login/yylogin';
</script>
    <style type="text/css">
        #duihao{
            color: green;
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo U('kan',array('hid'=>$d['hid']));?>">查其健康信息</a> | <a href="<?php echo U('fa',array('hid'=>$d['hid']));?>">发送信息 </a>
