...
/*				width: 37.9%;
	...
	<body>
	  <div id="top">
	  	 ...
	  	 <div class="hy">
	  	 	<?php echo $shuju['xingming'];?>&nbsp <span id="shu">|</span>&nbsp<a href="<?php echo U('Login/out');?>" class="tc">退出</a>
	  	 </div>
	  </div>

	  <!-- 导航开始 -->
	  <div id="daohang">
	  	  			<span id='kahao'>卡号：<?php echo $shuju['kahao'];?></span>
	  	<div class="zouqi">
			...
			<a id="cao" href="<?php echo U('Yh/wanshan');?>">完善用户信息</a>
				...
				用户信息
					...
					<ul id="yhxx">
						...
						<li style="position:relative;">&nbsp&nbsp&nbsp&nbsp&nbsp既往史：<?php echo $shuju['jiwangshi'];?> <a href="" id="dianji">点击查看</a></li>
						<li style="border:none;position:relative;" >&nbsp&nbsp&nbsp&nbsp&nbsp过敏史：<?php echo $shuju['guominshi'];?><a href="" id="dianji2">点击查看</a></li>
					</ul>
...
<!-- 					<a href="" class="xinxi">姓名：<?php echo $shuju['xingming'];?>&nbsp&nbsp性别：<?php echo $shuju['xingbie'];?>&nbsp&nbsp出生日期：<?php echo $shuju['shengri'];?></a>
			...
			<img src="http://127.0.0.1/baojiandaifu/YIYUAN/Index/View/Index/2.gif" style="height:100px;margin-left:360px; width:70%; margin-top:-100px;" alt="">
	...
	<script type="text/javascript" src="http://127.0.0.1/baojiandaifu/YIYUAN/Index/View/Index/haha.js"> 
