...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        #neirong{
            ...
            <h1 id="toubu"><strong>添加保健医院</strong></h1>
                <div class="angle"></div>
            </div>
                        ...
                        <div id="infoSta">
                            <div id="accountstatus2">
                            	  <dl id="authValiCode">
									...
									<dd>
										<input class="inp" name="yiyuanname" id="nikename" type="text">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
									<dt id="mobile_dt">等级</dt>
									<dd>
										<input class="inp" name="yiyuandengji" id="nikename" type="text">
										<div class="prompt" id="nikename_msg"></div>
									</dd>
<!--                                     <dt id="mobile_dt">服务热线</dt>
                    ...
                    <input type="file" name='yy_img' class='inp'/>
                                    ...
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yyusername" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                                    <dt id="mobile_dt">密码：</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yypassword" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
                        ...
                        <dl>
                            ...
                            <dt id="mobile_dt">类型</dt>
                                    <dd id="mobile_dd">
                                        <input class="inp" name="yiyuanleixing" id="mobile_new" type="text">
                                        <div class="prompt" id="mobile_msg"></div>
                                    </dd>
