...
URL = 'http://localhost/baojiandaifu/index.php/Admin/User/index';
...
CONTROLLER = 'http://localhost/baojiandaifu/index.php/Admin/User';
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/User/index';
...
CONTROLLERVIEW = 'http://localhost/baojiandaifu/YIYUAN/Admin/View/User';
...
<!--             <td><?php echo $d['duser'];?></td>
            ...
            <td>
                ...
                <a href="<?php echo U('del',array('uid'=>$d['uid']));?>" onclick="return confirm('你确定将该代理的代理资格删除么?');">删除</a> 
            </td>
        </tr>
...
<script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Admin/View/User/js/js.js"></script>
<div class='page1'>
   <?php echo $page;?>
</div>
</body>
