	...
	<style type="text/css">
		*{ padding: 0; margin: 0;}
		...
		#cont_right{ position: absolute; top: 0px; left: 0px; right: 0; bottom: 0; }
		 .cont_lr{ height: 28px; border-top: 1px #fff solid; border-bottom: 1px #d4d4d4 solid; background: url(http://localhost/baojiandaifu/YIYUAN/Index/View/Index/images/navs_bg.png) repeat-x;}
        ...
        table #btn1{ width:70px; height:32px; font-size:12px; background: url(http://localhost/baojiandaifu/YIYUAN/Index/View/Index/images/login_user.png) repeat-x; border: none; color: #fff; letter-spacing: 1px; border-radius: 3px; padding-left: 10px;} 
		.sub{ width: 80px; height: 32px; color: #fff; background: url(http://localhost/baojiandaifu/YIYUAN/Index/View/Index/images/login_user.png) repeat-x; border: none; border-radius: 2px; font-size: 14px; letter-spacing: 1px; margin:5px 0 5px 80px; font-weight: 700;}
		...
		.contt table td ul .lists a span{ width: 20px; float: right; line-height: 21px; height: 21px; display: block; background: url(http://localhost/baojiandaifu/YIYUAN/Index/View/Index/images/jia.png) no-repeat;}
		.contt table td ul .lists a b{ width: 20px; float: right; height: 21px; line-height: 21px; display: block; background: url(http://localhost/baojiandaifu/YIYUAN/Index/View/Index/images/jian.png) no-repeat;}
...
URL = 'http://localhost/baojiandaifu/index.php/Index/Index/fa/hid/34';
...
CONTROLLER = 'http://localhost/baojiandaifu/index.php/Index/Index';
ACTION = 'http://localhost/baojiandaifu/index.php/Index/Index/fa';
...
CONTROLLERVIEW = 'http://localhost/baojiandaifu/YIYUAN/Index/View/Index';
HISTORY = 'http://localhost/baojiandaifu/index.php/Index/Index/yyindex';
</script>
</head>
<body>
<div id="cont_right">
	        ...
	        <div id="content">
	        	<table border="0">
	                ...
	                <tr>
	        			...
	        			<td>
	        				<script type="text/javascript" charset="utf-8" src="http://localhost/baojiandaifu/hdphp/hdphp/Extend/Org/Ueditor/ueditor.config.js"></script><script type="text/javascript" charset="utf-8" src="http://localhost/baojiandaifu/hdphp/hdphp/Extend/Org/Ueditor/ueditor.all.min.js"></script><script type="text/javascript">UEDITOR_HOME_URL="http://localhost/baojiandaifu/hdphp/hdphp/Extend/Org/Ueditor/"</script><script id="hd_content" name="content" type="text/plain"></script>
        <script type='text/javascript'>
        $(function(){
                var ue = UE.getEditor('hd_content',{
                serverUrl:'http://localhost/baojiandaifu/index.php?m=Index&c=Index&hid=34&a=ueditor_upload&water='//图片上传脚本
                ,zIndex : 1000
...
<script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Index/Js/js.js"></script>
</body>
</html>