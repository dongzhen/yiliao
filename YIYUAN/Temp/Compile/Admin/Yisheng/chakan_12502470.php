...
URL = 'http://localhost/baojiandaifu/index.php/Admin/Yisheng/chakan';
...
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/Yisheng/chakan';
...
HISTORY = 'http://localhost/baojiandaifu/index.php/Admin/Yisheng/chakan';
</script>
    <style type="text/css">
        #duihao{
            color: green;
    ...
    <script src="http://localhost/baojiandaifu/YIYUAN/Admin/View/Yisheng/js/jquery-1.7.min.js" type="text/javascript"></script>
<script src="http://localhost/baojiandaifu/YIYUAN/Admin/View/Yisheng/js/Area.js" type="text/javascript"></script>
<script src="http://localhost/baojiandaifu/YIYUAN/Admin/View/Yisheng/js/AreaData_min.js" type="text/javascript"></script>
...
if($_index_y>=$_total_y):$hd["list"]["y"]["last"]=true;endif;?>
        ...
        <tr>
            <td style="display:none;"><?php echo $y['yid'];?></td>
            <td><?php echo $y['yishengname'];?></td>
            <td><?php echo $y['keshi'];?></td>
