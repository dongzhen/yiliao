...
URL = 'http://localhost/baojiandaifu/index.php/Admin/Yysq/xinxi/yy_id/1';
...
ACTION = 'http://localhost/baojiandaifu/index.php/Admin/Yysq/xinxi';
...
HISTORY = 'http://localhost/baojiandaifu/index.php/Admin/Yysq/index';
</script>
    <style type="text/css">
        #out{
            width: 800px;
    ...
    <div id="out">
        ...
        <div class="two">
            <div class="three">
                ...
                <ul> 
                    <li>医院名称：<?php echo $data['yy_name'];?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp医院等级：<?php echo $data['yy_dengji'];?></li>
                    <li>申请人姓名：<?php echo $data['yy_shenqingren'];?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp民族：<?php echo $data['ys_minzu'];?></li>
                    <li>医院类型:<?php echo $data['yy_leixing'];?></li>
                    <!-- <li>医院担任职位：<?php echo $data['ys_zhiwei'];?></li> -->
                    <li>联系电话：<?php echo $data['yy_number'];?></li>
