...
<head>
	...
	<style type="text/css">
		*{ padding: 0; margin: 0; background: #f4f7f9;}
		input{ border: none;}
		#boxs{ width: 400px; height: 300px; position: relative; top: 10%; left: 50%; margin-left:-226px; margin-top:120px; background: #fff; border: 2px #e5e5e5 solid; border-radius: 8px;}
