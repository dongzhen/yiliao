...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    	<script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/tongji-1.js" type="text/javascript" charset="utf-8"></script>
        ...
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/public.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/topics.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/pop.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/20140925.css" rel="stylesheet" type="text/css">
        <link href="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/formStyle.css" rel="stylesheet" type="text/css">
        <style>
        #toubu{
        	position: absolute;
        	left: 38%;
        ...
        #neirong{
            ...
            </script></head><body><div id="baidu_stat_id" style="display:none;"><script src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/h.js" type="text/javascript"></script></div>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/jquery-1.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/baihe.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/city.js" charset="utf-8"></script>
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/jquery.js" charset="utf-8"></script>    
            <script type="text/javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/reg_landpage.js" charset="utf-8"></script>
            <script language="javascript" src="http://localhost/baojiandaifu/YIYUAN/Index/View/Login/data/ckadinfo.js" charset="utf-8"></script>
